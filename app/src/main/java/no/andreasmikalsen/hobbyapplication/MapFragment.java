...
import static no.andreasmikalsen.hobbyapplication.Utility.Constants.MAPVIEW_BUNDLE_KEY;
...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LatLngBounds boundsNorway = new LatLngBounds(new LatLng(59.394886, 10.574767), new LatLng(59.779745, 10.873618));
