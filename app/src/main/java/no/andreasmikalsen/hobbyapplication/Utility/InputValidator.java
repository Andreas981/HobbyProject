...
public class InputValidator {
    ...
    public static Pair<Boolean, String> isPasswordGood(String password, String repeatPassowrd){
        ...
        if(passwordLength < 10){
            return new Pair<>(false, "The password is to short, needs to be at least 1 0characters");
        }
    ...
    public static Pair<Boolean, String> isPinGood(String pin, String repeat){
        ...
        if(pin.length() > 9 || repeat.length() > 9){
            return new Pair<>(false, "maximum nine digits");
        }
